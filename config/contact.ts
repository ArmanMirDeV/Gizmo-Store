...
export const contactConfig = {
  company: {
    name: process.env.NEXT_PUBLIC_COMPANY_NAME || "GizmoStore",
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@gizmo-store.com",
    ...
    description:
      ...
      "Discover amazing products at GizmoStore, your trusted online shopping destination for quality items and exceptional customer service.",
  },
  businessHours: {
    weekday:
  ...
  emails: {
    support: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@gizmo-store.com",
    sales: process.env.NEXT_PUBLIC_SALES_EMAIL || "sales@gizmo-store.com",
  },
  responseTime: {
    standard:
  ...
  legal: {
    copyright:
      ...
      "© 2024 GizmoStore. All rights reserved.",
