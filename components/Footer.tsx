      ...
      <Container>
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <SocialMedia
              ...
              tooltipClassName="bg-dark-color text-black"
            />
          </div>
        ...
        <div className="py-6 border-t text-center text-sm text-gray-600">
          <p>
            ...
            <span className="text-dark-color font-black tracking-wider  hover:text-shop_dark_green hoverEffect group font-sans">
              Gizmo
